...
/**
 * Test for transaction WIKJT77701MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/WIKJT77701MXTest.xml" })
public class WIKJT77701MXTransactionTest {

	@Autowired
	private WIKJT77701MXTransaction transaction;
